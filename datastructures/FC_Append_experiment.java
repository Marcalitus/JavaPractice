 ...
 * 
 */
public class FC_Append_experiment 
{
	...
	public static void main(String[] args) throws ClassNotFoundException 
	{
		...
		String inputFile1 = "datasets/fc_1.csv";
		String inputFile2 = "datasets/fc_2.csv";

		String outputFilename = "datasets/appended.csv";
	...
	public static boolean reduceFC2usingFC1()
	{
		...
		if (count==0)
		{
			System.out.println("FC 2 is completely reducible by FC 1");
			System.out.println("No output file created, FC 1 file is consistent");
			return true;
		}
		else
		{
			System.out.println("FC 2 is not completely reducible by FC 1");
			return false;
		}
	}
